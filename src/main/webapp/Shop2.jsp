...
<section id="sample">
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-1.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
            ...
            <h6>Rs.1000/-.</h6>
            <h3>Rs.750.</h3>
            <a class="sam-kart" href="#">
                <i class="fa-solid fa-cart-shopping"></i>
            </a>
        </div>
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-2.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-3.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-4.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-5.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-6.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-7.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-8.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-9.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-10.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-11.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="sam">
            <img class="imgs" alt="not-found" src="images/shirt-12.webp">
            <h4>T-shirt in cotton fabric.</h4>
            <h5>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
    ...
    <section id="switch-btn-1">
        <div class="switch-btn-2">
            <a href="Shop.jsp">1</a>
        </div>
        <div class="switch-btn-2">
            <a href="Shop2.jsp" class="active-2">2</a>
        </div>
        <div class="switch-btn-2">
